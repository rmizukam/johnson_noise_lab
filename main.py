...
tri3 = Trial_Data(np.array([1.003, 1.004, 1.005, 1.003, 1.004]),100,200)
...
freqtri1 = Frequency_Trial_Data(np.array([0.926, 0.926,0.925, 0.924, 0.925]),10000,1000, np.array([100, 100000, 110961]))
